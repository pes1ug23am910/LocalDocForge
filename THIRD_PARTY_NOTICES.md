...
|---|---:|---:|---:|---|---|
| Lite | 54 | 52 | 19 | [notices](THIRD_PARTY_NOTICES.lite.md) | [SBOM](docs/SBOM.lite.cdx.json) |
| Standard | 55 | 52 | 19 | [notices](THIRD_PARTY_NOTICES.standard.md) | [SBOM](docs/SBOM.standard.cdx.json) |
| Full | 56 | 52 | 19 | [notices](THIRD_PARTY_NOTICES.full.md) | [SBOM](docs/SBOM.full.cdx.json) |
...
The pydantic-core 2.46.4 embedded Cargo SBOM remains unflattened and is an explicit inventory gap, not an absence claim.
The rpds-py 2026.6.3 supplier SBOM retains 15 required and two excluded Cargo children. Their identities are reviewed but unflattened, and missing child copyright/license texts keep composition and redistribution notice coverage incomplete.
