...
compression) were generated by the complete gate with:
...
|---|---|---:|
| package source inputs | `32b645769366b28516860eb19c3e10859e7549dd94a03bf7b4a0dd83f634a4b8` | — |
| `localdocforge-0.1.0-py3-none-any.whl` | `540a36212cc2adbf21cb321ad0a684b806a26ef8fb7ddaae942d2fff0dccbff3` | 96,696 |
| `localdocforge-0.1.0.tar.gz` | `7bd03dfbe3a817da05a26f490ededb67f8cd9482bfc190e7076be3222ca6ea91` | 83,262 |

`packaging-evidence/windows-11-x64-SHA256SUMS.txt` authenticates both retained
files. The superseded 2026-07-20 artifacts (wheel `392d0952…`, 92,228 B;
sdist `4675fa04…`, 80,014 B) were not deleted: they are archived with their
original checksum file in `dist/windows-11-x64-2026-07-20/`. Refresh the
manifest only after inspecting intentional package-source changes; never
update it merely to hide drift. (The 2026-08-03 refresh followed an
intentional change: the drift check first failed exactly as designed, and the
manifest was regenerated only after the new sources passed the full gate.)
